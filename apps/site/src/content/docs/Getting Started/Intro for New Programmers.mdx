...
The answer the the former is that you can't learn Nospace without learning Whitespace! Nospace shares syntax and runtime behavior with Whitespace, so anything you learn about Whitespace is helping you learn Nospace at the same time.
